...
public class Imp2Parser implements Imp2ParserConstants {
    ...
    public static void main(String args[]) {
        ...
        // ... (Lógica de leitura dos args e parser permanece igual) ...
        if (args.length == 0) {
            ...
            // Lógica de tratar parâmetros de entrada (args[1]...)
        ...
        try {
            ...
            // --- CORREÇÃO DO AMBIENTE DE COMPILAÇÃO ---
            // 1. Criar o ambiente de compilação separadamente
            AmbienteCompilacaoImperativa ambCompilacao = new ContextoCompilacaoImperativa(entrada);

            // 2. INICIALIZAR O ESCOPO GLOBAL PARA COMPILAÇÃO (Isso corrige o erro no Load/ChecaTipo)
            ambCompilacao.incrementa();

            if(programa.checaTipo(ambCompilacao)) {

                // --- AMBIENTE DE EXECUÇÃO ---
                AmbienteExecucaoImperativa2 ambiente = new ContextoExecucaoImperativa2(entrada);
                ambiente.incrementa(); // Já estava correto aqui, mas o programa falhava antes de chegar aqui
 ...
 */
  static final public Comando PShow() throws ParseException {
    ...
    if (jj_2_2(2147483647)) {
      ...
      switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
      case IDENTIFIER:
        // Caminho 3: SHOW dataframe OU SHOW variavel
                // (LIMIT removido conforme solicitado)
                idVar = jj_consume_token(IDENTIFIER);
          retorno = new Show(new Id(idVar.toString()));
        break;
      default:
        jj_la1[6] = jj_gen;
        jj_consume_token(-1);
 ...
 */
  ...
  static final public ListaDeclaracaoParametro PListaDeclaracaoParametro() throws ParseException {
    ...
    ModoParametro modo = ModoParametro.POR_VALOR;
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case NAME:
      jj_consume_token(NAME);
               modo = ModoParametro.POR_NOME;
      break;
    default:
      jj_la1[18] = jj_gen;
      ;
    ...
    tipo = PTipo();
    id = PId();
       // Usa o construtor novo que aceita o modo
       lista = new ListaDeclaracaoParametro(new DeclaracaoParametro(id, tipo, modo));
    label_1:
    while (true) {
      switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
      case COMMA:
      ...
      // Verifica de novo
            ...
            tipo = PTipo();
      id = PId();
         lista = new ListaDeclaracaoParametro(new DeclaracaoParametro(id, tipo, modo), lista);
    }
  ...
  static {
   ...
   private static void jj_la1_init_0() {
      jj_la1_0 = new int[] {0x0,0xea3b8000,0x180000,0x10000000,0x8008000,0x10000000,0x0,0x6000,0x6000,0x6000,0x1800,0x6000,0xea3b8000,0xea3b8000,0x1008000,0x1000000,0x4000000,0x0,0x4000000,0x0,0x4000000,0x7800,0x0,};
   }
   private static void jj_la1_init_1() {
      jj_la1_1 = new int[] {0x10000000,0xa4003ff,0x0,0x0,0x0,0x0,0x400000,0x0,0x188000,0x2588000,0x0,0x2588000,0xa4003ff,0xa4003ff,0x2000000,0x0,0x8007000,0x7000,0x0,0x0,0x0,0x2588000,0x0,};
   }
   private static void jj_la1_init_2() {
      jj_la1_2 = new int[] {0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x40000,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x1,0x0,0x40000,0x1,};
   }
